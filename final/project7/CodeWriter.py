...
class CodeWriter:
    ...
    def gt_arithmetic(self) -> str:
        ...
        return "// gt ///////////////////////\n" + CodeWriter.POP_VALUE_Y + CodeWriter.POP_VALUE_X + \
               CodeWriter.NEGATIVE_SIGN_Y(self.cond_index) + CodeWriter.NEGATIVE_SIGN_X(self.cond_index) + gt_check + \
               CodeWriter.BAD_CONDITION_I(self.cond_index) + CodeWriter.GOOD_CONDITION_I(self.cond_index) + CodeWriter.PUSH_D_I(self.cond_index)
    ...
    def lt_arithmetic(self) -> str:
        ...
        return "// lt  ///////////////////////\n" + CodeWriter.POP_VALUE_Y + CodeWriter.POP_VALUE_X + \
                CodeWriter.NEGATIVE_SIGN_Y(self.cond_index) + CodeWriter.NEGATIVE_SIGN_X(self.cond_index) + lt_check + \
