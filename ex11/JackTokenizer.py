...
class JackTokenizer:
    ...
    def get_valid_lines(input_stream: typing.TextIO) -> [str]:
        ...
        for line in input_stream:
            no_comment_line, comment_open, current_comment = \
    ...
    @staticmethod
    def comment_handler(line: str, comment_open: bool, current_comment) -> tuple[str, bool, str]:
        ...
        if comment_open:
            no_comment_line, comment_open, current_comment = JackTokenizer.remove_comments(line, current_comment)

        return no_comment_line, comment_open, current_comment

    @staticmethod
    def remove_comments(line: str, comment: str) -> tuple[str, bool, str]:
        no_comment = ""
        comment_open = True
        ...
        return no_comment, comment_open, comment
